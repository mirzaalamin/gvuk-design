...
export async function generateMetadata({ params }) {
    ...
    return {
        ...
        alternates: {
            canonical: `https://www.gvukdesign.co.uk/industry-solutions/tooling-and-engineering/${slug}`,
        },
        openGraph: {
            title,
            url: `https://www.gvukdesign.co.uk/industry-solutions/tooling-and-engineering/${slug}`,
