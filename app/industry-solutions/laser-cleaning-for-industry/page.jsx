...
export const metadata = {
    title: "Laser Cleaning for Industry | GVUK Design",
    description:
        "Your Gemvision, EnvisionTEC and Coherent–Rofin specialist distributor for the UK and Ireland",
    alternates: {
        canonical: "https://www.gvukdesign.co.uk/industry-solutions/laser-cleaning-for-industry",
    },
    openGraph: {
        title: "Laser Cleaning for Industry | GVUK Design",
        url: "https://www.gvukdesign.co.uk/industry-solutions/laser-cleaning-for-industry",
...
const page = async () => {
    ...
    const products = await getProductsByCategory(64)
        ...
        <div>
            ...
            <div className='primary-gradient dark:bg-gray-800 pt-[100px]'>
                <div className="container">
                    <Hero title="Laser Cleaning for Industry" description="Hand-held on in-line laser cleaners removes rust, grime grease and paint without damaging the substructure."
                        imgUrl="/assets/images/laserstar_cleaning_for_industry_4101_4102.png"
