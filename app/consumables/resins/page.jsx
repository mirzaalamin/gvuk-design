                        ...
                        <div className='flex flex-col gap-10'>
                            <div className='dark:bg-gray-800 flex flex-col py-6 bg-primary'>
                                ...
                                <div className='px-4 text-white'>
                                    <h2 className="h4">Resin Enquiry Form</h2>
                                    <p className="post-description !leading-6 !text-white">Please complete the form below to enquire about our resin availability, pricing and delivery timescales.</p>
                                </div>
                                <div className='mt-10'>
                                    <iframe
